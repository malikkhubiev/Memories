...
export const searchApi = createApi({
  ...
  endpoints: (builder) => ({
    getTagsBySubstring: builder.mutation<tagType[], { substring: string }>({
      query: ({ substring }) => ({
...
export const useGetTagsBySubstring =
  searchApi.endpoints.getTagsBySubstring.useMutation;
export const useGetUsersBySubstring =
  searchApi.endpoints.getUsersBySubstring.useMutation;
export const useGetFollowersOrFollowingsBySubstr =
  searchApi.endpoints.getFollowersOrFollowingsBySubstr.useMutation;
export const useGetBlockedUsersBySubstr =
  searchApi.endpoints.getBlockedUsersBySubstr.useMutation;
export const useGetImageLikersBySubstr =
  searchApi.endpoints.getImageLikersBySubstr.useMutation;

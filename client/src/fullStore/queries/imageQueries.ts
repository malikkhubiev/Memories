...
export const imageApi = createApi({
  ...
  endpoints: (builder) => ({
    upload: builder.mutation<imageType, FormData>({
      query: (FormData) => ({
        url: "/upload",
        method: "POST",
        body: FormData,
    ...
    getImageMutation: builder.mutation<imageType, { imageId: number }>({
      query: ({ imageId }) => ({
        url: `/get:${imageId}`,
        method: "GET",
      }),
    }),
    save: builder.mutation<{ message: string }, { imageId: number }>({
      query: ({ imageId }) => ({
        url: "/save",
        method: "PUT",
        body: {
    ...
    unSave: builder.mutation<{ message: string }, { imageId: number }>({
      query: ({ imageId }) => ({
        url: "/unSave",
        method: "PUT",
        body: {
    ...
    hide: builder.mutation<{ message: string }, { imageId: number }>({
      query: ({ imageId }) => ({
        url: "/hide",
        method: "PUT",
        body: {
    ...
    show: builder.mutation<{ message: string }, { imageId: number }>({
      query: ({ imageId }) => ({
        url: "/show",
        method: "PUT",
        body: {
    ...
    view: builder.mutation<{ message: string }, { imagesIds: number[] }>({
      query: ({ imagesIds }) => ({
        url: "/view",
        method: "POST",
        body: {
    ...
    like: builder.mutation<{ message: string }, { imageId: number }>({
      query: ({ imageId }) => ({
        url: "/like",
        method: "PUT",
        body: {
    ...
    unLike: builder.mutation<{ message: string }, { imageId: number }>({
      query: ({ imageId }) => ({
        url: "/unLike",
        method: "PUT",
        body: {
    ...
    delete: builder.mutation<{ message: string }, { imageId: number }>({
      query: ({ imageId }) => ({
        url: "/delete",
        method: "DELETE",
        body: {
...
export const useGetImageMutation =
  imageApi.endpoints.getImageMutation.useMutation;
...
export const useNotInterestedImage =
  imageApi.endpoints.notInterested.useMutation;

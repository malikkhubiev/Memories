...
export const commentApi = createApi({
  ...
  endpoints: (builder) => ({
    add: builder.mutation<commentType, { imageId: number; text: string }>({
      query: ({ imageId, text }) => ({
        url: "/add",
        method: "POST",
        body: {
    ...
    like: builder.mutation<{ message: string }, { commentId: number }>({
      query: ({ commentId }) => ({
        url: "/like",
        method: "PUT",
        body: {
    ...
    unLike: builder.mutation<{ message: string }, { commentId: number }>({
      query: ({ commentId }) => ({
        url: "/unLike",
        method: "PUT",
        body: {
    ...
    delete: builder.mutation<{ message: string }, { commentId: number }>({
      query: ({ commentId }) => ({
        url: "/delete",
        method: "DELETE",
        body: {

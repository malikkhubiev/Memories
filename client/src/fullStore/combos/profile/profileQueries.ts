...
export const profilesApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        sendASubscriptionRequest: builder.mutation<
            any,
            { userId: number }
        >({
            query: ({ userId }) => ({
        ...
        confirmSubRequest: builder.mutation<
            any,
            { userId: number }
        >({
            query: ({ userId }) => ({
        ...
        denySubRequest: builder.mutation<
            any,
            { userId: number }
        >({
            query: ({ userId }) => ({
...
export const useSetPreferences = profilesApi.endpoints.setPreferences.useMutation;
export const useSendASubscriptionRequest = profilesApi.endpoints.sendASubscriptionRequest.useMutation;
export const useConfirmSubRequest = profilesApi.endpoints.confirmSubRequest.useMutation;
export const useDenySubRequest = profilesApi.endpoints.denySubRequest.useMutation;
...
export const unBlockThunk = createAsyncThunk(
    ...
    async (userId: number, {rejectWithValue}) => {
        try {
            await $authHost.post<
            null
        >("/user/unBlock", { unBlockingId: userId });
        } catch (e) {
            return rejectWithValue(e.response.data.message);
        };
    }

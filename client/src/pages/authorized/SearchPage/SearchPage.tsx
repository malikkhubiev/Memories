...
import { useGetTagsBySubstring, useGetUsersBySubstring } from '../../../fullStore/queries/searchQueries';
...
export const SearchPage: FC<{}> = () => {
    ...
    const { data: images, isLoading: isGetImByPrefLoading, error } = useGetImagesByPreferences(null);

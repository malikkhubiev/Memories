...
import { blockThunk, unBlockThunk } from '../../../fullStore/combos/profile/profileQueries';
...
export const BlockedPage: FC<{}> = () => {
    ...
    const [blockedUsers, setBlockedUsers] = useState<
        blockedUserType[] | []
    >([]);
    const [blockedNumber, setBlockedNumber] = useState<string>(user?.blocked?.count || "0");
    ...
    const searchHandler = (searchValue: string) => {
        ...
        if (searchValue !== "") {
            ...
            if (customBlockedUsers.length) {
                ...
                setBlockedNumber(prev =>
                    prev = transformNumber(counter));
            } else {
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            usualDispatch(updateBlockedUsers({
                ownId: id,
                unblockedUsers
            }));
        };

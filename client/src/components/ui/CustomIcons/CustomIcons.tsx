...
const commonStyle = (width?: string) => ({
  width: width || "25px",
  cursor: "pointer",
});

export const CustomSearchIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
    <svg style={commonStyle(width)} focusable="false" viewBox="0 0 24 24">
...
export const CustomMoreVerticalIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomUnsaveIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomHideImageIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomDeleteIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomNotInterestedIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomDownloadIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
    <svg style={commonStyle(width)} focusable="false" viewBox="0 0 24 24">
      <path d="M5 20h14v-2H5v2zM19 9h-4V3H9v6H5l7 7 7-7z">{children}</path>
    </svg>
  );
};

export const CustomArrowBackIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomBookmarkIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomFilledBookmarkIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomDateIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomStarIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomLikeIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomShareIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
    <svg
      style={{ width: width || "25px", transform: "scale(-1, 1)" }}
      focusable="false"
      viewBox="0 0 24 24"
    >
...
export const CustomFilledLikeIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
    <svg
      style={{ width: width || "25px", fill: "red" }}
      focusable="false"
      viewBox="0 0 24 24"
    >
...
export const CustomClearIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomBlockIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomSettingsIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomSendIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
    <svg style={commonStyle(width)} focusable="false" viewBox="0 0 24 24">
      <path d="M2.01 21 23 12 2.01 3 2 10l15 2-15 2z">{children}</path>
    </svg>
  );
};

export const CustomHomeIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
    <svg style={commonStyle(width)} focusable="false" viewBox="0 0 24 24">
      <path d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z">{children}</path>
    </svg>
  );
};

export const CustomAddIcon: FC<{ width?: string; children?: ReactElement }> = ({
  width,
  children,
}) => {
  return (
    <svg style={commonStyle(width)} focusable="false" viewBox="0 0 24 24">
      <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z">{children}</path>
    </svg>
  );
};

export const CustomEditIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomUploadIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
    <svg style={commonStyle(width)} focusable="false" viewBox="0 0 24 24">
      <path d="M9 16h6v-6h4l-7-7-7 7h4zm-4 2h14v2H5z">{children}</path>
    </svg>
  );
};

export const CustomCommentsIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomBroomIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomShowImageIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomListIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomAccountCircle: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (
...
export const CustomArrowOutwardIcon: FC<{
  width?: string;
  children?: ReactElement;
}> = ({ width, children }) => {
  return (

...
import { LinkedinIcon, LinkedinShareButton, MailruIcon, MailruShareButton, OKIcon, OKShareButton, TelegramIcon, TelegramShareButton, ViberIcon, ViberShareButton, VKIcon, VKShareButton, WhatsappIcon, WhatsappShareButton } from "react-share";
...
let socialMedia: any = [
    { id: 1, props: { button: MailruShareButton, icon: MailruIcon, name: "Mail.ru" } },
    { id: 2, props: { button: LinkedinShareButton, icon: LinkedinIcon, name: "LinkedIn" } },
    { id: 3, props: { button: OKShareButton, icon: OKIcon, name: "OK" } },
    { id: 4, props: { button: TelegramShareButton, icon: TelegramIcon, name: "Telegram" } },
    { id: 5, props: { button: ViberShareButton, icon: ViberIcon, name: "Viber" } },
    { id: 6, props: { button: VKShareButton, icon: VKIcon, name: "VK" } },
    { id: 7, props: { button: WhatsappShareButton, icon: WhatsappIcon, name: "WhatsApp" } }
];

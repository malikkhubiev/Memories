...
import { blockUnblockActionType, followUnfollowActionType, toggleButtonCallbackType } from '../../../types/callbacks';

export const ToggleButton: FC<ToggleButtonPropsType> = (
    { type, disabled, buttonText, toggleButtonCallback }) => {
...
type ToggleButtonPropsType = {
    ...
    buttonText: followUnfollowActionType |
    blockUnblockActionType | "send request" | "request sended" | "confirm"

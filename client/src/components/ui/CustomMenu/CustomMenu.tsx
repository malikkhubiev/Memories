...
import { chatsMenuOptionsActionsType, commentMenuOptionsActionsType, imageMenuOptionsActionsType, messagesMenuOptionsActionsType, optionActionCallbackType } from '../../../types/callbacks';

export const CustomMenu: FC<CustomMenPropsType> = (
    { menuOptions, imgSrc, side, callback, iconWidth, url, ...props }) => {
    ...
    return <>
        ...
        >
            {menuOptions.map((option: any) => 
                url ?
                <MenuItem key={option.id} onClick={() => ownHandler(option.props.body)}>
                        {
                            option.component ?

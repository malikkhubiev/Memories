...
import { useLikeComment, useUnLikeComment } from '../../../fullStore/queries/commentQueries';
import { commentMenuOptionsActionsType, menuOptionsHandlerCallbackType, optionActionCallbackType } from '../../../types/callbacks';
...
export const Comment: FC<CommentPropsType>
    = ({ id, authorId, authorName, isOwn, avatar, menuOptionsHandlerCallback,
        createdAt, text, numberOfLikes, isLiked }) => {
        ...
        const like = () => {
            ...
            likeComment({ commentId: id }).unwrap()
                .then(() => {
        ...
        const unLike = () => {
            usualDispatch(setIsLoading(true));
            unLikeComment({ commentId: id }).unwrap()
                .then(() => {

...
import { CustomStack, SmallGoldenRatioBox } from '../../ui/customStyledComponents';
...
export const Profile: FC<ProfilePropsType>
    = ({ id,
        ...
        const giveCurrentImagesCallback: giveCurrentImagesCallbackType = (
            result
        ) => {
        ...
        let imagesForShow = (images && images.length) ?
            JSON.parse(JSON.stringify(images)).reverse() : [];

...
import { SmallGreyText, TypographyWithEllipsis } from '../../ui/customStyledComponents';
import styles from './Chats.module.less';

export const Chat: FC<ChatPropsType> = (
    { setChatIdCallback, id, chatterAva, chatterName,
        isCurrent, lastMessage, newMessagesNumber }) => {

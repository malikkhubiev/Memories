...
import { CustomClearIcon, CustomMoreVerticalIcon } from '../../ui/CustomIcons/CustomIcons';
...
export const Message: FC<MessagePropsType> = (
    { id, isOwn, text, createdAt, messageOptionsCallback }) => {

    const handler = () => {
        messageOptionsCallback(id);
    };
    const menuOptions = [{ id: 1, component: BasicMenuComponent, props: { body: "Delete from me", icon: CustomClearIcon } }];
        ...
        >
            <div className={styles.container}>
                ...
                <Body
                    sx={{
                        backgroundColor:
                            () => isOwn ? "primary.main" : "secondary.main",
                        borderRadius:

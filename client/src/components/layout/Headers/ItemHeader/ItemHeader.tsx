...
import { chatsMenuOptionsActionsType, commentMenuOptionsActionsType, imageMenuOptionsActionsType, optionActionCallbackType } from '../../../../types/callbacks';
import { CustomAvatar } from '../../../ui/CustomAvatar/CustomAvatar';
import { CustomMoreVerticalIcon } from '../../../ui/CustomIcons/CustomIcons';
import { CustomMenu } from '../../../ui/CustomMenu/CustomMenu';
import { CustomStack, TypographyWithEllipsis } from '../../../ui/customStyledComponents';
import styles from './ItemHeader.module.less';

export const ItemHeader: FC<ItemHeaderPropsType> = (
    { authorId, authorName,
        menuOptions, avatar, createdAt, optionActionCallback, imgSrc }) => {

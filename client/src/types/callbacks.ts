...
export type messagesMenuOptionsActionsType =
  ...
  | "Delete chat"
  | "Block user";
export type commentMenuOptionsActionsType = "Delete";
...
export type uploadImageCallbackType = (
  event: React.ChangeEvent<HTMLInputElement>,
) => void;
export type imageProcessedCallbackType = (
  canvas: HTMLCanvasElement,
  imgfile: File,
) => void;
export type readyImageCallbackType = (
  canvas: HTMLCanvasElement,
  imgfile: File,
) => void;
...
export type imageMenuHandlerType = (
  imageId: number,
  action: imageMenuOptionsActionsType,
  images: imageType[],
...
export type menuOptionsHandlerCallbackType = (
  itemId: number,
  action?: imageMenuOptionsActionsType,
) => void;

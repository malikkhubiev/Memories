...
const { hide, get, deleteImage, notInterested, upload, save, like, unLike, view, show, unSave } = require("../services/imageService");
...
class imageController {
    upload = async(req, res, next) => {
        try {
            ...
            if (filter.isProfane(description)) throw new Error("Your description is profane");
            JSON.parse(tags).forEach(tag => {
                if (filter.isProfane(tag.name)) throw new Error("One of your tags or image is profane");
            });

            const image = await upload(
                authorId, description, JSON.parse(tags), img
            );
            res.json(image);
        } catch (e) {
    ...
    get = async(req, res, next) => {
        try {
            ...
            if (!imageId) throw new Error(
                "You didn't specify which image you want to get"
            );
    ...
    save = async(req, res, next) => {
        try {
            ...
            if (!imageId) throw new Error(
                "You didn't specify which image you want to save"
            );
    ...
    unSave = async(req, res, next) => {
        try {
            ...
            if (!imageId) throw new Error(
                "You didn't specify which image you want to unsave"
            );
    ...
    hide = async(req, res, next) => {
        try {
            ...
            if (!imageId) throw new Error(
                "You didn't specify which image you want to hide"
            );
    ...
    show = async(req, res, next) => {
        try {
            ...
            if (!imageId) throw new Error(
                "You didn't specify which image you want to show"
            );
    ...
    like = async(req, res, next) => {
        try {
            ...
            if (!imageId) throw new Error(
                "You didn't specify which image you want to like"
            );
    ...
    unLike = async(req, res, next) => {
        try {
            ...
            if (!imageId) throw new Error(
                "You didn't specify which image you want to unlike"
            );
    ...
    delete = async(req, res, next) => {
        try {
            ...
            if (!imageId) throw new Error(
                "You didn't specify which image you want to delete"
            );
